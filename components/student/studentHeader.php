...
<div class="header">
    <div style="padding-left: 10px;width: 20%;" ><i class='fas fa-user-alt' style='font-size: 34px;color:white;margin-right: 10px;'></i><span><?php echo $_SESSION[StudentName] ?></span></div>
