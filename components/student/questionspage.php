...
if (!(isset($_SESSION[StudentID]))) {
    ...
    $check = $_GET['pId'];
    $data = (array)json_decode(getQuestions($_SESSION[StudentID], 'student'));
...
<body>
    ...
    <div class="main-container">
        <div class="parentContainer">
            ...
            <?php echo "<div><button class='button' id='view-question' style='vertical-align:middle;margin-top:20px;width: 400px;height: 100px;border-radius: 38px;font-size:36px;background-color: #1ebb2bc2;font-weight:600;'><span>Post New Question </span></button></div>";?>
            ...
            <div class="card">
                <div class="container">
                    ...
                    <?php echo "<p id='professor-id' style='display:none;'>" . $check . "</p>";?>
    ...
    <script>
         $(document).ready(function() {
            ...
            $(`#view-question`).click(function(){
                    const qID = "none";
                    const pID = $(`#professor-id`).html();
                    const cID = $(`#professor-id`).html();
                document.location.href = "./questionanswerpage.php?qId="+qID+"&pId="+pID+"&cID="+cID;
            });
